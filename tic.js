//Récuperer tous les élements necessaires //
let cases = [...document.getElementsByClassName("case")];
let joueur = document.getElementById("joueur");
let score1 = document.getElementById("score1");
let score2 = document.getElementById("score2");
let scoreNull = document.getElementById("matchNull");
//Créer un objet Javascript qui décrit notre jeu//
let state = 
{
    joueurEnCours : 1,
    scoreJ1 : 0 ,
...
{
    if( (state.c1 == state.c2  && state.c2 == state.c3  && state.c1 >0 )||
    ...
    else if(state.c1 !=0 && state.c2 !=0 && state.c3 !=0 && state.c4 !=0 && state.c5 !=0 && state.c6 !=0 && state.c8 !=0 && state.c9 !=0 ){
         return null;}
    else {
        return false ; 
    }
...
const jouerCase = (e)=>  {
    ...
    if(isVictoire == true){
    alert("Le gagnant est " + state.joueurEnCours)
    if(joueurEnCours === 1){
        state.scoreJ1++;
